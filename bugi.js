const bot = function () {
    ...
    const bugi = document.getElementById('bugi');
    const container = document.getElementById('bugi-container');
    const inner = document.getElementById('bugi-inner');
    ...
    const insertNewChatItem = function (elem) {
        //container.insertBefore(elem, bugi);
        bugi.appendChild(elem);
        scrollContainer();
        //debugger;
    ...
    const handleChoice = async function (e) {
        ...
        if (!e.target.classList.contains('choice') || 'A' === e.target.tagName) {
            ...
            var button = e.target.closest('#bugi-container .choice');
